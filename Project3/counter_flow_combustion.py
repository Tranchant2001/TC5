...
class CounterFlowCombustion():
    ...
    def __init__(self, L:float, physN:float, L_slot:float, L_coflow:float, D:float, pho:float, max_t_comput:datetime.timedelta, show_save:bool, register_period:int, ell_crit:float, div_crit:float, conv_crit:float):
