...
def plot_scalar_field(some_array, **kwargs):
    ...
    if 'saveaspng' in kwargs.keys():
        plt.savefig(dirpath+"/results_3_gauss-siedel/"+kwargs.get('saveaspng'), dpi=128, bbox_inches="tight")
...
for k in range(len_Nl):
    ...
    while kiter < niter+1 and eps > norm_th:
        ...
        Up1 = update_gauss_siedel(U, beta_arr)
